...
class Game(engine.Game):
	...
	def update(self, delta_time):
		...
		world.create(Ball, sprite_filename="ball1.png", layer="main", x=(self.frame*10)%screen_width, y=300, change_y=10, change_x=(self.frame*737)%31, elasticity=0.8)
		print(self.frame)
		if self.frame >= 2000:
...
#world.create(Ball, sprite_filename="ball1.png", layer="main", gravity_y=-0.3, change_x=6, change_y=10)
